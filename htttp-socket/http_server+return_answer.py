...
def parse_http_protocol(text_response):
...
print('---HTTP MESSAGE---')
print(content)
print('___END OF MESSAGE---')
sock.send(content.encode())
result = sock.recv(16384)
status_code, headers, content = parse_http_protocol(result.decode())
print('Statuse Code: {}'.format(status_code))
